...
class CBAlgorithmTFIDF2(CBAlgorithm):
    ...
    def index(self, data):
        ...
        '''
        data = super(CBAlgorithmTFIDF2, self).index(data)
    ...
    def similarity(self, index=None):
        ...
        if index is None:
            index = self.indexed
        super(CBAlgorithmTFIDF2, self).similarity(index)
        return self.add_similarity(index)