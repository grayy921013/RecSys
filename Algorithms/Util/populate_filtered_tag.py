...
def main(argv):
    snert = StanfordNERTagger('Lib/Stanford-NER/stanford-ner-2017-06-09/classifiers/english.all.3class.distsim.crf.ser.gz', 'Lib/Stanford-NER/stanford-ner-2017-06-09/stanford-ner.jar')
